...
"""
Support vector classification action testing module
"""
...
def test_binary_response_data_yields_positve_reward(dummy_binary_response_data) -> None:
    ...
    action_result = support_vector_classification(state, dummy_binary_response_data)
...
def test_continous_response_data_yields_negative_reward(
    ...
    state.set("is_response_dichotomous", -1)
    action_result = support_vector_classification(state, dummy_continous_response_data)
    assert action_result.reward <= -0.5
